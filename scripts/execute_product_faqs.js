...
async function executeProductFAQs() {
  try {
    ...
    // Read SQL file
    const sqlFilePath = path.join(__dirname, '../supabase/create_product_faqs_table.sql');
    ...
    console.log('🚀 Executing SQL migration for product_faqs...');
    ...
    console.log('✅ Table product_faqs created successfully!');
