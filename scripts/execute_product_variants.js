...
async function executeProductVariants() {
  try {
    ...
    // Read SQL file
    const sqlFilePath = path.join(__dirname, '../supabase/create_product_variants_table.sql');
    ...
    console.log('🚀 Executing SQL migration for product_variants...');
